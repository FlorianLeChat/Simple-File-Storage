		...
		<main className="container mx-auto max-w-[1440px] p-8 max-md:p-4 max-md:pb-8">
			...
			<section className="flex flex-col space-y-6 text-justify text-sm">
				...
				<p>
					...
					<br />
					<strong>Prestations et Services :</strong> {title} met à
				...
				<p>
					...
					{title} pour la gestion de votre compte, de la gestion de la
				...
				<p>
					...
					il est précisé aux utilisateurs du site internet {title}{" "}
				...
				<p>
					L&lsquo;utilisation du site {title} implique
					l&lsquo;acceptation pleine et entière des conditions
					générales d&lsquo;utilisation ci-après décrites. Ces
					conditions d&lsquo;utilisation sont susceptibles
					d&lsquo;être modifiées ou complétées à tout moment, les
					utilisateurs du site {title} sont donc invités à les
				...
				<p>
					...
					{title}, qui s&lsquo;efforcera alors de communiquer
					préalablement aux utilisateurs les dates et heures de
					l&lsquo;intervention. Le site Internet {title} est mis à
					jour régulièrement par {title}. De la même façon, les
					mentions légales peuvent être modifiées à tout moment :
					elles s&lsquo;imposent néanmoins à l&lsquo;utilisateur qui
					est invité à s&lsquo;y référer le plus souvent possible afin
					d&lsquo;en prendre connaissance.
				</p>
				<h3 className="text-2xl font-bold tracking-tight">
					3. Description des services fournis.
				</h3>
				<p>
					Le site internet {title} a pour objet de fournir une
					information concernant l&lsquo;ensemble des activités de la
					société. {title} s&lsquo;efforce de fournir sur le site{" "}
					{title} des informations aussi précises que possible.
				...
				<p>
					Toutes les informations indiquées sur le site {title} sont
					données à titre indicatif, et sont susceptibles
					d&lsquo;évoluer. Par ailleurs, les renseignements figurant
					sur le site {title} ne sont pas exhaustifs. Ils sont donnés
				...
				<p>
					...
					{title} est hébergé chez un prestataire sur le territoire de
				...
				<p>
					{title} et l&lsquo;hébergeur ne pourront être tenus
					responsables en cas de dysfonctionnement du réseau Internet,
					des lignes téléphoniques ou du matériel informatique et de
					téléphonie lié notamment à l&lsquo;encombrement du réseau
					empêchant l&lsquo;accès au serveur.
				</p>
				<h3 className="text-2xl font-bold tracking-tight">
					5. Propriété intellectuelle et contrefaçons.
				</h3>
				<p>
					{title} est propriétaire des droits de propriété
					intellectuelle et détient les droits d&lsquo;usage sur tous
					...
					interdite, sauf autorisation écrite préalable de : {title}.
				</p>
				<p>
				...
				<p>
					{title} agit en tant qu&lsquo;éditeur du site. {title} est
					responsable de la qualité et de la véracité du Contenu
					qu&lsquo;il publie.
				</p>
				<p>
					{title} ne pourra être tenu responsable des dommages directs
					et indirects causés au matériel de l&lsquo;utilisateur, lors
					de l&lsquo;accès au site internet {title}, et résultant soit
					de l&lsquo;utilisation d&lsquo;un matériel ne répondant pas
					aux spécifications indiquées au point 4, soit de
					l&lsquo;apparition d&lsquo;un bug ou d&lsquo;une
					incompatibilité.
				</p>
				<p>
					{title} ne pourra également être tenu responsable des
					dommages indirects (tels par exemple qu&lsquo;une perte de
					marché ou perte d&lsquo;une chance) consécutifs à
					l&lsquo;utilisation du site {title}. Des espaces interactifs
					(possibilité de poser des questions dans l&lsquo;espace
					contact) sont à la disposition des utilisateurs. {title} se
					...
					données. Le cas échéant, {title} se réserve également la
					possibilité de mettre en cause la responsabilité civile
					et/ou pénale de l&lsquo;utilisateur, notamment en cas de
				...
				<p>
					...
					Données Personnelles est : Florian Trayon. {title} est
					représenté par Florian Trayon, son représentant légal.
				</p>
				<p>
					En tant que responsable du traitement des données
					qu&lsquo;il collecte, {title} s&lsquo;engage à respecter le
					cadre des dispositions légales en vigueur. Il lui appartient
					notamment au Client d&lsquo;établir les finalités de ses
					...
					conforme à la réalité. Chaque fois que {title} traite des
					Données Personnelles, {title} prend toutes les mesures
					raisonnables pour s&lsquo;assurer de l&lsquo;exactitude et
					de la pertinence des Données Personnelles au regard des
					finalités pour lesquelles {title} les traite.
				</p>
				<h4 className="text-xl font-medium">
					7.2 Finalité des données collectées
				</h4>
				<p>
					{title} est susceptible de traiter tout ou partie des
					données :
				</p>
				<ul className="list-inside list-disc">
					...
					<li>
						pour mener des campagnes de communication (courriel)
					</li>
				</ul>
				<p>
					{title} ne commercialise pas vos données personnelles qui
				...
				<p>
					...
					Utilisateurs de {title} disposent des droits suivants :
				</p>
				<ul className="list-inside list-disc">
					<li>
					...
					<li>
						...
						après leur mort et de choisir à qui {title} devra
						communiquer (ou non) ses données à un tiers qu&lsquo;ils
						aura préalablement désigné
					</li>
				</ul>
				<p>
					Dès que {title} a connaissance du décès d&lsquo;un
					Utilisateur et à défaut d&lsquo;instructions de sa part,{" "}
					{title} s&lsquo;engage à détruire ses données, sauf si leur
					conservation s&lsquo;avère nécessaire à des fins probatoires
					ou pour répondre à une obligation légale.
				</p>
				<p>
					Si l&lsquo;Utilisateur souhaite savoir comment {title}{" "}
					utilise ses Données Personnelles, demander à les rectifier
					ou s&lsquo;oppose à leur traitement, l&lsquo;Utilisateur
					peut contacter {title} par écrit à l&lsquo;adresse suivante
					:
				</p>
				...
				<p>
					...
					Personnelles qu&lsquo;il souhaiterait que {title} corrige,
					mette à jour ou supprime, en s&lsquo;identifiant précisément
					avec une copie d&lsquo;une pièce d&lsquo;identité (carte
					d&lsquo;identité ou passeport).
				</p>
				<p>
					Les demandes de suppression de Données Personnelles seront
					soumises aux obligations qui sont imposées à {title} par la
					loi, notamment en matière de conservation ou
					d&lsquo;archivage des documents. Enfin, les Utilisateurs de{" "}
					{title} peuvent déposer une réclamation auprès des autorités
					de contrôle, et notamment de la CNIL
				...
				<p>
					{title} s&lsquo;interdit de traiter, héberger ou transférer
					les Informations collectées sur ses Clients vers un pays
					situé en dehors de l&lsquo;Union européenne ou reconnu comme
					« non adéquat » par la Commission européenne sans en
					informer préalablement le client. Pour autant, {title} reste
				...
				<p>
					{title} s&lsquo;engage à prendre toutes les précautions
					nécessaires afin de préserver la sécurité des Informations
					et notamment qu&lsquo;elles ne soient pas communiquées à des
					personnes non autorisées. Cependant, si un incident
					impactant l&lsquo;intégrité ou la confidentialité des
					Informations du Client est portée à la connaissance de{" "}
					{title}, celle-ci devra dans les meilleurs délais informer
					le Client et lui communiquer les mesures de corrections
					prises. Par ailleurs {title} ne collecte aucune « données
					sensibles ».
				</p>
				<p>
					Les Données Personnelles de l&lsquo;Utilisateur peuvent être
					traitées par des filiales de {title} et des sous-traitants
					(prestataires de services), exclusivement afin de réaliser
				...
				<p>
					...
					Utilisateurs de {title} sont principalement les agents de
				...
				<p>
					...
					site {title} n&lsquo;est publiée à l&lsquo;insu de
					l&lsquo;utilisateur, échangée, transférée, cédée ou vendue
					sur un support quelconque à des tiers. Seule
					l&lsquo;hypothèse du rachat de {title} et de ses droits
					permettrait la transmission des dites informations à
					l&lsquo;éventuel acquéreur qui serait à son tour tenu de la
					même obligation de conservation et de modification des
					données vis à vis de l&lsquo;utilisateur du site {title}.
				</p>
				<h4 className="text-xl font-medium">Sécurité</h4>
				<p>
					Pour assurer la sécurité et la confidentialité des Données
					Personnelles et des Données Personnelles de Santé, {title}{" "}
				...
				<p>
					Lors du traitement des Données Personnelles, {title}
				...
				<p>
					Le site {title} contient un certain nombre de liens
					hypertextes vers d&lsquo;autres sites, mis en place avec
					l&lsquo;autorisation de {title}. Cependant, {title}{" "}
				...
				<p>
					{title} est susceptible de traiter les informations de
					l&lsquo;Utilisateur concernant sa visite du Site, telles que
					les pages consultées, les recherches effectuées. Ces
					informations permettent à {title} d&lsquo;améliorer le
					contenu du Site, de la navigation de l&lsquo;Utilisateur.
				</p>
				<p>
					...
					dans son terminal. {title} informe l&lsquo;Utilisateur que,
				...
				<p>
					...
					également être le cas lorsque {title} ou l&lsquo;un de ses
					prestataires ne peut pas reconnaître, à des fins de
					compatibilité technique, le type de navigateur utilisé par
					le terminal, les paramètres de langue et d&lsquo;affichage
					ou le pays depuis lequel le terminal semble connecté à
					Internet.
				</p>
				<p>
					Le cas échéant, {title} décline toute responsabilité pour
					les conséquences liées au fonctionnement dégradé du Site et
					des services éventuellement proposés par {title}, résultant
					(i) du refus de Cookies par l&lsquo;Utilisateur (ii) de
					l&lsquo;impossibilité pour {title} d&lsquo;enregistrer ou de
					consulter les Cookies nécessaires à leur fonctionnement du
					fait du choix de l&lsquo;Utilisateur. Pour la gestion des
					Cookies et des choix de l&lsquo;Utilisateur, la
					configuration de chaque navigateur est différente. Elle est
					décrite dans le menu d&lsquo;aide du navigateur, qui
					permettra de savoir de quelle manière l&lsquo;Utilisateur
				...
				<p>
					...
					Cookies. {title} pourra en outre faire appel aux services de
					prestataires externes pour l&lsquo;aider à recueillir et
				...
				<p>
					...
					sur le Site de {title} ou dans son application mobile et si
					l&lsquo;Utilisateur a accepté le dépôt de cookies en
					poursuivant sa navigation sur le Site Internet ou
					l&lsquo;application mobile de {title}, Twitter, Facebook,
				...
				<p>
					...
					mobile de {title}. À tout moment, l&lsquo;Utilisateur peut
					néanmoins revenir sur son consentement à ce que {title}{" "}
				...
				<p>
					{title} peut employer occasionnellement des balises Internet
				...
				<p>
					Cette technologie permet à {title} d&lsquo;évaluer les
					réponses des visiteurs face au Site et l&lsquo;efficacité de
					ses actions (par exemple, le nombre de fois où une page est
					ouverte et les informations consultées), ainsi que
					l&lsquo;utilisation de ce Site par l&lsquo;Utilisateur.
				</p>
				<p>
					...
					sur l&lsquo;activité du Site à l&lsquo;attention de {title},
				...
				<p>
					...
					{title} est soumis au droit français. En dehors des cas où
					la loi ne le permet pas, il est fait attribution exclusive
					de juridiction aux tribunaux compétents de Cannes.
				</p>
			</section>
		</main>
	);
